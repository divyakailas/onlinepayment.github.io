...
if (isset($_GET['sub']))
{
	...
	$query="UPDATE reg1 SET middlename='$middlename',lastname='$lastname',mobileno='$mobilenumber',state='$state',birthdate='$birthdate',gender='$gender',address='$address',email='$EMAIL' WHERE firstname='$firstname' ";
	$run=mysqli_query($conn,$query);
	
	if($run)
	{
		echo"You have update successfully.<a href='customerreport.php'>check list</a>";
		...
		<div class="col-xs-7 col-sm-6 col-lg-10 m-auto">
			...
			<div class="card-title ">
				<div class="form" >
					...
					<center><input class="btn btn-success" type="submit" name="sub" value="Update"/></center>
					&nbsp;&nbsp;&nbsp;&nbsp;
