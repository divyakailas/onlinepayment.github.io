...
//query="select generatebill.consumerno,generatebill.name,generatebill.billdate,generatebill.duedate,generatebill.currentreading,generatebill.totalreading ,paybill.totalamount  left outer join paybill on  generatebill.id=paybill.id"; 
...
<center><h1>elecricity Report</h1></center>
	<tr>
	...
	while($result=mysqli_fetch_assoc($data))
	{
		...
		<td><a href='elecdelete.php?fn=$result[consumerno]' >Delete</a></td>
		</tr>";
