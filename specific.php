...
<center><h2><div class="text-danger">Electricity Bill</div></h2></center>

<label for="username"><b><div class="text-white">Consumner No</div></b></label>
<input class="form-control" type="text" name="consumerno" placeholder="consumer no" required="">
...
if (isset($_REQUEST['LOGIN'])) 
{
	...
	$query = mysqli_query($con,"select * from  generatebill  where consumerno='".$_REQUEST['consumerno']."'&&  name='".$_REQUEST['name']."' ")or die ("sql error" .mysqli_error());
