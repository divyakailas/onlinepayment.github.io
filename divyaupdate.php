		...
		<div class="col-xs-7 col-sm-6 col-lg-10 m-auto">
			...
			<div class="card-title ">
				<div class="form" >
					...
					<form  action="divyaupdate.php" method="POST">
				    <h4> Customer Registration Form</h4>
					<hr class="mb-3">
					<div class="form-row">   
					 <div class="col">
					<h5><label  class="control-label " for="firstname"><b>First Name</b></label></h5>
					<input class="form-control" type="text" name="firstname" placeholder="FirstName"  required="" pattern="[A-Za-z]+" title="please enter first name">
					 </div >
					 
					 <div class="col">
					<h5><label  class="control-label " for="middlename"><b>Middle Name</b></label></h5>
					<input class="form-control" type="text" name="middlename" placeholder="MiddleName"  required pattern="[A-Za-z]+" title="please enter your middlename">
					</div>
					
					 <div class="col">
					<h5><label  class="control-label" for="lastname"><b>Last Name</b></label></h5>
					<input class="form-control" type="text" name="lastname" placeholder="LastName" required pattern="[A-Za-z]+" title="please enter your lastname">
					</div>
					</div>
					<div class="form-row">   
					 <div class="col">
					<h5><label for="mobilenumber"><b>Mobile Number</b></label></h5>
					<input class="form-control" type="text" name="mobilenumber" placeholder="Mobile Number" required pattern="[0-9]{10}" title="please enter 10 digit mobile number" >
					</div>
					
					<div class="col">
					<h5><label for="state"><b>State</b></label></h5>
					<input class="form-control" type="text" name="state" placeholder="state" required pattern="[A-Za-z]+" title="please enter state">
					</div>
					</div>
					...
					<textarea class="form-control" name="address" rows="4" cols="30" required pattern="[A-Za-z]+" title="please enter valid address"></textarea>
					</div>
					</div>
					...
					<input  class="form-control" type="email" name="email" placeholder="Email" required="" title="please enter valid email address">
					</div>
					</div>
					<hr>
					...
					<input class="form-control" type="text" name="username" placeholder="UserName" required pattern="[A-Za-z]+" title="please enter username">
					</div>
					</div>
