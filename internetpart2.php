...
if(isset($_POST['makepayment']))
{
	...
	$query="insert into internetpay2(accountno,transactionpass,amount)values('$accountno','$transactionpass','$amount')";
		...
		<div class="card mt-5 bg-light  border-dark">
			...
			<div class="form-row">
				<div class="col">
					...
					<input class="form-control" type="text" name="accountno" placeholder=""required pattern="[0-9]{9,18}" title="please enter no between 9 to 18 digit " >
