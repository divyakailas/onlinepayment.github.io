...
<head>
	...
	function validation()
	{
		...
		if(bank=="")
		{
			document.getElementById('bname').innerHTML ="please enter first name";
			return false;
		}
	}
	</script>
...
if(isset($_POST['makepayment']))
{
	...
	$query="insert into paywater(bankname,cardno,cvvno,holdername,totalamount,expirymonth,expiryyear,cardtype)values('$bankname','$cardno','$cvvno','$holdername','$totalamount','$expirymonth','$expiryyear','$cardtype')";
		...
		<div class="card mt-5 bg-light  border-dark">
			...
			<div class="form-row">
				<div class="col">
					...
					<input class="form-control" type="text" name="bankname" id="bank" placeholder="" required pattern="[A-Z a-z]+" title="enter bank name">
					<div id="bname"></div>
			...
			<div class="form-row">
					<div class="col">
					<input class="btn btn-success" onclick="validation();" type="submit" name="makepayment" value="Make Payment">
					</div>
			</div>
