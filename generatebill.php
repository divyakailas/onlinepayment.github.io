...
if(isset($_POST['creditcard']))
{
	...
	$query="insert into generatebill(consumerno,name,billdate,duedate,currentreading,totalreading)values('$consumerno','$name','$billdate','$duedate','$currentreading','$totalreading')";
...
if(isset($_POST['internetbank']))
{
	...
	{
		echo"payment information saved successfully!!";
		header("Location:internetpart1.php");
...
<div class="form">
	<div class="row">
		<div class="col-md-6 m-auto">
			...
			<h4><b>pay your electricity bill</b></h4>
			<hr>
			<div class="form-row">
				<div class="col">
					<h5><label  class="control-label " for="consumerno">Consumer No</label></h5>
					<input class="form-control" type="text" name="consumerno" placeholder="please enter 12 digit number" title="please enter 12 dight number" required pattern="[0-9]{12}" >
				</div>
			...
			<div class="form-row">
				<div class="col">
					...
					<input class="form-control" type="text" name="currentreading" required pattern="[0-9]+"  placeholder="" >
				</div>
				
				<div class="col">
					<h5><label  class="control-label " for="totalreading">Total reading</label></h5>
					<input class="form-control" type="text" name="totalreading" required pattern="[0-9]+"  placeholder="" >
				</div>
